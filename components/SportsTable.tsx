...
const SportsTable: React.FC<Props> = ({
  columns,
  data,
  tableName,
  timeline,
    ...
    const getData = async () => {
      ...
      try {
        const data = await axios.post(
          `${process.env.NEXT_PUBLIC_API_URL}/table/get-table-data`,
          tableInfo
        );
    ...
    <div className="my-5 flex flex-col items-center">
      <div className="w-full">
        <div className="border-b-4 border-b-black">
          <h3 className="text-left font-semibold text-2xl w-0 min-w-full">
                            ...
                            (column: {
                              ...
                              <>
                                <th
                                  ...
                                  style={{
                                    borderColor: getHeaderColor(column),
                                  }}
                                >
                                  {
                                    // Render the header
