  ...
  const columns = useMemo<Column<ColumnType>[]>(
    ...
    <div className="flex">
      ...
      <div className="flex flex-col items-center w-screen ml-28">
        <SportsTable columns={columns} data={myData} name="O/U 2.5 1H RUNS - HOME TEAM" timeline='since 2017 - Jul 26st, 2021'/>
        <SportsTable columns={columns} data={data} name='O/U 2.5 1H RUNS - HOME TEAM' timeline='2021- as of July 26st' />
        <SportsTable columns={columns} data={data} name='DIVISION GAMES - O/U 2.5 1H RUNS - HOME TEAM' timeline='2017 - 2021 as of July 26st' />
        <SportsTable columns={columns} data={data} name='DIVISION GAMES - O/U 2.5 1H RUNS - HOME TEAM' timeline='2021 as of July 26th' />
