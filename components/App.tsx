...
const App: React.FC = () => {
  const baseballHomeNonDivisionData = useAppSelector(
    (store) => store.baseballHomeNonDivision2017
  );
  const baseballHomeDivisionData = useAppSelector(
    (store) => store.baseballHomeDivision2017
  );
  const baseballHomeNonDivision2022Data = useAppSelector(
    (store) => store.baseballHomeNonDivision2022
  );
  const baseballHomeDivision2022Data = useAppSelector(
    (store) => store.baseballHomeDivision2022
  );

  const baseballVisitorNonDivisionData = useAppSelector(
    (store) => store.baseballVisitorNonDivision2017
  );
  const baseballVisitorDivisionData = useAppSelector(
    (store) => store.baseballVisitorDivision2017
  );
  const baseballVisitorNonDivision2022Data = useAppSelector(
    (store) => store.baseballVisitorNonDivision2022
  );
  const baseballVisitorDivision2022Data = useAppSelector(
    (store) => store.baseballVisitorDivision2022
  );
