...
export const baseballVisitorNonDivision2022 = createSlice({
    ...
    initialState: addToInitialState(initialState, 2022, SPORT_NAME.BASEBALL, false, false),
    reducers: {
        updateBaseballVisitorNonDivision2022Data: (state: DataType[], action: PayloadAction<PayloadData>) => {
        ...
        updateBaseballVisitorNonDivision2022FullData: (state: DataType[], action: PayloadAction<any>) => {
...
export const { updateBaseballVisitorNonDivision2022Data, updateBaseballVisitorNonDivision2022FullData } =
